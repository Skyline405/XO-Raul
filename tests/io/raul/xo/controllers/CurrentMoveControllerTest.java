...
public class CurrentMoveControllerTest {
    ...
    @Test
    public void testCurrentMoveWhenMoveO() throws Exception {
    ...
    @Test
    public void testCurrentMoveWhenMoveX() throws Exception {
        final CurrentMoveController currentMoveController = new CurrentMoveController();
    ...
    @Test
    public void testCurrentMoveWhenMoveNobody() throws Exception {
        final CurrentMoveController currentMoveController = new CurrentMoveController();
